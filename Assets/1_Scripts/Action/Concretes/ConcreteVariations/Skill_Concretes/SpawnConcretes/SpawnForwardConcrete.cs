...
public class SpawnForwardConcrete : BaseConcrete
{
    private BaseActor _caster;
    private EnemyInstantiationInfo _info;
    private int _idx;
    public SpawnForwardConcrete
    (
    ...
    {
        return new SpawnForwardConcrete(TurnProcessorInst, LevelMasterInst, clonedAction, ActionPassedConditions, Tag, _info, _caster);
    }
}
