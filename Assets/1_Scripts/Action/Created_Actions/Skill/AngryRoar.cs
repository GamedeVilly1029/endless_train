...
public class AngryRoar: BaseAction 
{
    public override void InitializeChildAction()
    {
        CooldownMax = 1;
        Cooldown = 0;
        if (Resources.Load<GameObject>("SkillActionUI/AngryRoarActionUI") != null)
        {
            UIRepresentation = Resources.Load<GameObject>("SkillActionUI/AngryRoarActionUI");
        }
        else
        {
    ...
    private void InitializeConstruct()
    {
        ActionConstruct = new()
        {
            new IncreaseDamageOfNextAttackConcrete(TurnProcessorInstance, LevelMasterInstance, this, null, ActionConcreteTag.Skill, Actor)
        };
    }
