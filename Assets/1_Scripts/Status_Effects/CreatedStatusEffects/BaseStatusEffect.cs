...
public class BaseStatusEffect : IStatusEffect
{
    ...
    public virtual void ChildInitialize(BaseActor actor)
    {
    ...
    private void BaseInitialization(TurnProcessor turnProcessor, LevelMaster levelMaster, BaseActor actor)
    {
