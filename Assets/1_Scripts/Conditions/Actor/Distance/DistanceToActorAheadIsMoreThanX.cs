...
public class DistanceToActorAheadIsMoreThanX : BaseConditionCommand
{
    private int _value;
    private BaseActor _caster;
    public DistanceToActorAheadIsMoreThanX(TurnProcessor turnProcessor, LevelMaster levelMaster, int value, BaseActor caster) : base(turnProcessor, levelMaster)
    {
        _value = value;
        _caster = caster;
    }
